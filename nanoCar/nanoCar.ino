...
void setup(){
  ...
  pinMode(in2, OUTPUT);
  pinMode(in1Steer, OUTPUT); //Declaring the pin modes, obviously they're outputs
  pinMode(in2Steer, OUTPUT);
...
void loop() {
  ...
  if(ps2x.ButtonPressed(PSB_CIRCLE)){digitalWrite(LED_BUILTIN, HIGH); }
